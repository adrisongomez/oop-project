...
public class ProductController {
    ...
    public ResponseEntity<ProductDTO> createProduct(@Valid @RequestBody CreateProductInput req) {
    ...
    public ResponseEntity<ProductDTO> updateProduct(@PathVariable UUID id, @Valid @RequestBody UpdateProductInput req) {
    ...
    public ResponseEntity<ProductDTO> patchProduct(@PathVariable UUID id, @Valid @RequestBody PatchProductInput req) {
        Product existing = repository.findById(id).orElse(null);
        if (existing == null) {
            return ResponseEntity.notFound().build();
        }
