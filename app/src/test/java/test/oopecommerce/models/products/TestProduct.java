...
public class TestProduct {
        ...
        public void productSortImages() {
                ...
                images.add(new ProductMedia(UUID.randomUUID(), "Alternative Test", "www.wey.com", "image/jpg", 0));
                images.add(new ProductMedia(UUID.randomUUID(), "Alternative Test", "www.wey.com", "image/jpg", 2));
                images.add(new ProductMedia(UUID.randomUUID(), "Alternative Test", "www.wey.com", "image/jpg", 3));
                images.add(new ProductMedia(UUID.randomUUID(), "Alternative Test", "www.wey.com", "image/jpg", 5));
                images.add(new ProductMedia(UUID.randomUUID(), "Alternative Test", "www.wey.com", "image/jpg", 4));
                images.add(new ProductMedia(UUID.randomUUID(), "Alternative Test", "www.wey.com", "image/jpg", 1));
        ...
        public void productSortVariants() {
                ...
                variants.add(new ProductVariant(
                                ...
                                0,
                                "10"));
                Product product = new Product(null, null, null, null, null, variants);
